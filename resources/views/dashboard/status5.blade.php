                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <dl class="dl-horizontal">
                                        ...
                                        <dt name="trigger_animation">Client :</dt> <dd name="trigger_animation"><a href="#" class="text-navy">{{$perusahaan->perusahaan}}</a> </dd>
                                    </dl>
                                </div>
                                <div class="col-lg-7" id="cluster_info">
                                    <dl class="dl-horizontal">

                                        <dt name="trigger_animation">Mulai magang :</dt> <dd name="trigger_animation">16.08.2014</dd>
                                        <dt name="trigger_animation">Selesai pada :</dt> <dd name="trigger_animation">10.07.2014</dd>
                                        <dt name="trigger_animation">Lama magang :</dt> <dd name="trigger_animation">164 hari</dd>
                                    </dl>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <dl class="dl-horizontal">
                                        ...
                                        <dd>
                                            ...
                                            <small name="trigger_animation">Progres magang sebesar <strong>10%</strong>. Selamat menyelesaikan kegiatan magang.</small>
                                        </dd>
                                    </dl>
                                </div>
                            </div>
