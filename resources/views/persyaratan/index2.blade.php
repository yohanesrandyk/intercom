            ...
            <table class="table table-striped table-bordered table-hover" >
              ...
              <tbody>
                <tr  data-toggle="popover" data-placement="auto top" data-content="Menyelesaikan buku SKU." data-original-title="" title="">
                  <td>1</td>
                  <td>Bantara</td>
                  <td>@if($res->bantara == 1) <i class="fa fa-check-square text-navy"></i>  Selesai @else <i class="fa fa-square-o"></i> Belum terpenuhi @endif</td>
                </tr>
                <tr data-toggle="popover" data-placement="auto top" data-content="Menyelesaikan seluruh nilai mata pelajaran dari semester 1 sampai 4." data-original-title="" title="">
                  <td>2</td>
                  <td>Nilai</td>
                  <td>@if($res->nilai == 1) <i class="fa fa-check-square text-navy"></i>  Selesai @else <i class="fa fa-square-o"></i> Belum terpenuhi @endif</td>
                </tr>
                <tr data-toggle="popover" data-placement="auto top" data-content="Menyelesaikan administrai sesuai yang telah ditentukan." data-original-title="" title="">
                  <td>3</td>
                  <td>Keuangan</td>
                  <td>@if($res->keuangan == 1) <i class="fa fa-check-square text-navy"></i>  Selesai @else <i class="fa fa-square-o"></i> Belum terpenuhi @endif</td>
                </tr>
                <tr data-toggle="popover" data-placement="auto top" data-content="Hubungi bagian kesiswaan untuk informasi lebih lanjut." data-original-title="" title="">
                  <td>4</td>
                  <td>Kesiswaan</td>
                  <td>@if($res->kesiswaan == 1) <i class="fa fa-check-square text-navy"></i>  Selesai @else <i class="fa fa-square-o"></i> Belum terpenuhi @endif</td>
                </tr>
                <tr data-toggle="popover" data-placement="auto top" data-content="Mengikuti dan menyelesaikan seluruh rangkaian kegiatan CBT Produktif berdasar jurusan." data-original-title="" title="">
                  <td>5</td>
                  <td>CBT Produktif</td>
                  <td>@if($res->cbt_prod == 1) <i class="fa fa-check-square text-navy"></i>  Selesai @else <i class="fa fa-square-o"></i> Belum terpenuhi @endif</td>
                </tr>
                <tr data-toggle="popover" data-placement="auto top" data-content="Mengikuti seluruh rangkaian kegiatan pengayaan PKL." data-original-title="" title="">
                  ...
                  <td>@if($res->kehadiran_pengayaan_pkl == 1) <i class="fa fa-check-square text-navy"></i>  Selesai @else <i class="fa fa-square-o"></i> Belum terpenuhi @endif</td>
                </tr>
                <tr data-toggle="popover" data-placement="auto top" data-content="Mengikuti dan menyelesaikan seluruh rangkaian Uji Kelayakan berdasar jurusan." data-original-title="" title="">
                  ...
                  <td>@if($res->lulus_ujikelayakan == 1) <i class="fa fa-check-square text-navy"></i>  Selesai @else <i class="fa fa-square-o"></i> Belum terpenuhi @endif</td>
                </tr>
                <tr data-toggle="popover" data-placement="auto top" data-content="Mengembalikan buku pinjaman perpustakaan." data-original-title="" title="">
                  <td>8</td>
                  <td>Perpustakaan</td>
                  <td>@if($res->perpustakaan == 1) <i class="fa fa-check-square text-navy"></i>  Selesai @else <i class="fa fa-square-o"></i> Belum terpenuhi @endif</td>
                </tr>
              </tbody>
            </table>
          </div>
