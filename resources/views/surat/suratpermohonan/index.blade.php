                ...
                <tbody>
                  ...
                  <tr ondblclick="document.getElementById('{{$r->id_surat}}').click()">
                    ...
                    <td>
                      ...
                      <a href="{{url('suratpermohonan/del/'.encrypt($r->id_surat))}}" onclick="return confirm('Surat dengan nomer {{$r->nomersurat}} akan dihapus ?')"><i class="fa fa-trash text-danger"></i></a> |
                      <a onclick="
